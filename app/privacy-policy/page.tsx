export default function PrivacyPolicy() {
  return (
    <div className="flex justify-center items-center bg-slate-100 p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 space-y-6 text-gray-800 ">
        ...
        <ul className="list-disc list-inside">
          ...
          <li className="ml-6 mb-4">
            ...
            this Agreement) refers to SyntaxLab.
          </li>
          ...
          <li className="ml-6 mb-4">
            <strong>Website</strong> refers to SyntaxLab, accessible from
            <a href="https://syntaxlab.vercel.app/">
              https://syntaxlab.vercel.app/
            </a>
          </li>
          <li className="ml-6 mb-4">
        ...
        <p className="text-2xl font-bold">Types of Data Collected</p>

        <p className="text-xl font-bold">Personal Data</p>
        ...
        <ul className="list-disc list-inside">
          <li className="ml-6 mb-4">Email address</li>
          <li className="ml-6 mb-4">First name and last name</li>
          <li className="ml-6 mb-4">Usage Data</li>
        </ul>

        <p className="text-xl font-bold">Usage Data</p>
        ...
        <ul className="list-disc list-inside">
          <li className="ml-6 mb-2">Google</li>
          <li className="ml-6 mb-2">GitHub</li>
        </ul>
        ...
        <p className="text-xl font-bold">Tracking Technologies and Cookies</p>
        ...
        <ul className="list-disc list-inside">
          <li className="ml-6 mb-4">
            ...
            <p className="ml-6 mb-2 mt-2">Type: Session Cookies</p>

            <p className="ml-6 mb-2">Administered by: Us</p>
          ...
          <li className="ml-6 mb-4">
            ...
            <p className="ml-6 mb-2">Type: Persistent Cookies</p>
          ...
          <li className="ml-6 mb-4">
            <strong className="font-bold">Functionality Cookies</strong>

            <p className="ml-6 mb-2 mt-2">Type: Persistent Cookies</p>
        ...
        <p className="text-xl font-bold">Use of Your Personal Data</p>
        ...
        <p className="text-2xl font-bold">Retention of Your Personal Data</p>
        ...
        <p className="text-2xl font-bold">Transfer of Your Personal Data</p>
        ...
        <p className="text-2xl font-bold">Delete Your Personal Data</p>
        ...
        <p className="text-xl font-bold">Disclosure of Your Personal Data</p>

        <p className="text-xl font-bold">Business Transactions</p>
        ...
        <p className="text-xl font-bold">Law enforcement</p>
        ...
        <p className="text-xl font-bold">Other legal requirements</p>
        ...
        <ul className="list-disc list-inside">
          <li className="ml-6 mb-4">Comply with a legal obligation</li>
          <li className="ml-6 mb-4">
          ...
          <li className="ml-6 mb-4">Protect against legal liability</li>
        </ul>

        <p className="text-2xl font-bold">Security of Your Personal Data</p>
        ...
        <p className="text-3xl font-bold">Children&apos;s Privacy</p>
        ...
        <p className="text-3xl font-bold">Links to Other Websites</p>
        ...
        <p className="text-3xl font-bold">Changes to this Privacy Policy</p>
        ...
        <ul className="list-disc list-inside">
          <li className="ml-6 mb-4">
            By email: sandeepkrishnadonepudi@gmail.com
          </li>
        </ul>
      </div>
    </div>
