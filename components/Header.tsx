...
function Header({
  ...
  return (
    <>
      ...
      />
      <header className="relative z-20 flex flex-col md:flex-row justify-between items-center p-2 px-4 bg-slate-50 dark:bg-gray-800 text-gray-900 dark:text-white">
        <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
          ...
          <div
            className={clsx(
              ...
              "bg-slate-50/90 dark:bg-gray-800/90 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none",
              "p-4 md:p-0",
          ...
          >
            ...
            <button
              className={clsx(
                "bg-slate-700 hover:bg-slate-800 text-white font-semibold py-2 px-3 rounded",
